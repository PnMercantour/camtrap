...
def loadClassifier(site_id, visit, media, data_root):
...
def dumpClassifier(classifier, site_id, visit, media, data_root):
    "Assumes that classifier has been loaded before, no check on version here"
    path = data_root/'classification'/'media' / \
        str(site_id)/visit/(media + '.json')
    old_classifier = loadClassifier(site_id, visit, media, data_root)
...
if __name__ == '__main__':
    ...
    c = loadClassifier(6, '2020-03-11', 'IMG_0002.MP4', data_root)  # version 0
    d = loadClassifier(6, '2020-03-11', 'IMG_0002.MP4', data_root)  # version 0
    print(c)
    c['foo'] = 'bar'
    dumpClassifier(c, 6, '2020-03-11', 'IMG_0002.MP4',
                   data_root)  # bump to version 1
    e = loadClassifier(6, '2020-03-11', 'IMG_0002.MP4', data_root)
    print(e)
    dumpClassifier(d, 6, '2020-03-11', 'IMG_0002.MP4', data_root)  # rejected
